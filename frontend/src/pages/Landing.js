...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: '#F8FAFC'}}>
      ...
      <div className="py-24" style={{backgroundColor: '#F1F5F9'}}>
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-5xl font-bold mb-4" style={{color: '#0F172A'}}>Four Dimensions of Executive Presence</h2>
            <p className="text-xl" style={{color: '#64748B'}}>Research-backed scoring across key leadership indicators</p>
          </div>
