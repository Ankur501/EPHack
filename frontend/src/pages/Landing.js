      ...
      <div className="py-24 bg-secondary/50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-5xl font-bold mb-4 text-primary">Four Dimensions of Executive Presence</h2>
            <p className="text-xl text-muted-foreground">Research-backed scoring across key leadership indicators</p>
          </div>
