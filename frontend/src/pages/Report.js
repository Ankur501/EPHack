    ...
    <div className="min-h-screen bg-background">
      <nav className="bg-card border-b border-border">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Button variant="outline" data-testid="download-pdf">
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        <div className="text-center mb-12" data-testid="report-header">
          <h1 className="font-display text-5xl font-bold mb-4">Your EP Report</h1>
          <p className="text-lg text-muted-foreground mb-8">
            Here's how you came across in this 3-minute video across four dimensions: Gravitas, Communication, Presence, and Storytelling.
          </p>
          
          <div className="inline-flex items-center gap-4 bg-card border-2 border-accent rounded-2xl px-8 py-6">
            <div>
              <div className="font-mono text-6xl font-bold text-accent" data-testid="overall-score">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-12" data-testid="dimension-scores">
          {[
        ...
        <Accordion type="multiple" className="space-y-4" data-testid="dimensions-accordion">
        ...
        <Card className="mt-12 p-8 bg-accent/5 border-accent/20" data-testid="coaching-tips">
